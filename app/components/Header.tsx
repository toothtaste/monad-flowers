  ...
  return (
    <header>
      <div className="fixed left-5 top-8">
        <Image src={"/images/header/info.svg"} width={32} height={32} alt="info" className="cursor-pointer" />

        <div className="absolute -left-[29px] -bottom-8 -z-10 w-18 h-20">
          <Image src={"/images/header/dandelion.png"} fill alt="dandelion" />
        </div>
      </div>

      <div className="fixed left-0 right-0 flex justify-center pointer-events-none">
        <Image src={"/images/header/logo.svg"} width={166} height={71} alt="logo" />
        <h1
      ...
      <div className="fixed right-5 top-8">
        ...
        <div className="absolute -left-0.5 bottom-1 w-12 h-12">
          <Image src={"/images/header/violet.png"} fill alt="profile-flower" />
        </div>
      </div>
    </header>
  )
